...
parser.add_argument('-k', '--key_signature', type=str, help="Sets the key signature for the program", choices=key_sig, default="Eb")
...
gen_al_args.add_argument('--ngen', type=int, help="ngen sets the number of generations the GA will run for.", default=2)
...
gen_al_args.add_argument('--cxpb', type=float, help="cxpb sets the probability that an offspring is produced by crossover.", metavar="[0,1)", default=0.3)
gen_al_args.add_argument('--mutpb', type=float, help="mutb sets the probability that an offspring is produced by mutation.", metavar="[0,1)", default=0.7)
